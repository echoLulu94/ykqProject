 ...
 */
@Entity
@Table(name = "ath_resource", schema = "")
public class Resource implements Serializable{
	...
	/**资源值*/
	@Column(name ="resc_value",nullable=true)
	private String rescValue;
	/**资源名称*/
	@Column(name ="resc_name",nullable=true)
	private String rescName;
	/**uri类型:0-内部链接;1-外部链接*/
	@Column(name ="resc_uri_type",nullable=true)
	private String rescUriType;
	/**资源uri*/
	@Column(name ="resc_uri",nullable=true)
	private String rescUri;
	/**备注*/
	@Column(name ="resc_des",nullable=true)
